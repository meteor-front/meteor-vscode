...
exports.ZlstDefinitionProvider = void 0;
...
class ZlstDefinitionProvider {
                ...
                if (searchType === 'components') {
                    ...
                    if (attr === 'data' && braceLeftCount >= 2) {
                        ...
                        if (lineText.match(/{/gi)) {
                            braceLeft = ((_a = lineText.match(/{/gi)) === null || _a === void 0 ? void 0 : _a.length) || 0;
                        }
                        let braceRight = 0;
                        if (lineText.match(/}/gi)) {
                            braceRight = ((_b = lineText.match(/}/gi)) === null || _b === void 0 ? void 0 : _b.length) || 0;
                        }
                        ...
                        let braceLeft = 0;
                        if (lineText.match(/{/gi)) {
                            braceLeft = ((_c = lineText.match(/{/gi)) === null || _c === void 0 ? void 0 : _c.length) || 0;
                        }
                        let braceRight = 0;
                        if (lineText.match(/}/gi)) {
                            braceRight = ((_d = lineText.match(/}/gi)) === null || _d === void 0 ? void 0 : _d.length) || 0;
                        }
                        braceLeftCount += braceLeft - braceRight;
                    }
                    // data取return的属性值
    ...
    definitionOutFile(document, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // 1. 根据文件目录查询是否存在相应文件
            let config = vscode_1.workspace.getConfiguration('zlst');
...
exports.ZlstDefinitionProvider = ZlstDefinitionProvider;
